...
export const DOCUMENT_CATEGORY_LABELS: Record<DocumentCategory, string> = {
  ...
  DELIVERY: "Delivery",
  CUSTOMER: "Customer",
  PHI_OPERATIONAL: "Operational PHI",
};
...
export const DOCUMENT_TYPE_LABELS: Record<DocumentTypeKey, string> = {
  ...
  OTHER: "Other",
  RESUME: "Resume",
  CONFIDENTIALITY_ACK: "Confidentiality acknowledgement",
  MVR_AUTHORIZATION: "MVR authorization",
  BACKGROUND_AUTHORIZATION: "Background-check authorization",
...
export const TYPES_BY_CATEGORY: Record<DocumentCategory, DocumentTypeKey[]> = {
  ...
  APPLICANT_DOCUMENTS: ["RESUME", "BACKGROUND_CHECK", "DRIVERS_LICENSE", "AUTO_INSURANCE", "CONFIDENTIALITY_ACK", "MVR_AUTHORIZATION", "BACKGROUND_AUTHORIZATION", "POLICY_ACKNOWLEDGMENT", "OTHER"],
  APPLICANT: ["RESUME", "DRIVERS_LICENSE", "AUTO_INSURANCE", "HIPAA_TRAINING", "BLOODBORNE_PATHOGENS", "OSHA_TRAINING", "HAZMAT_HMR_TRAINING", "CONFIDENTIALITY_ACK", "MVR_AUTHORIZATION", "BACKGROUND_AUTHORIZATION", "POLICY_ACKNOWLEDGMENT", "OTHER"],
  HR: ["DRIVERS_LICENSE", "STATE_ID", "EMPLOYMENT_ELIGIBILITY", "HANDBOOK_ACKNOWLEDGMENT", "SIGNED_POLICY", "CONFIDENTIALITY_ACK", "BACKGROUND_CHECK", "MVR_AUTHORIZATION", "BACKGROUND_AUTHORIZATION", "POLICY_ACKNOWLEDGMENT", "OTHER"],
  DELIVERY: ["CHAIN_OF_CUSTODY", "PROOF_OF_PICKUP", "PROOF_OF_DELIVERY", "SHIPPING_PAPERWORK", "TEMPERATURE_LOG", "OTHER"],
  CUSTOMER: ["SERVICE_AGREEMENT", "BAA", "CUSTOMER_CONTRACT", "SLA", "OTHER"],
  PHI_OPERATIONAL: ["CHAIN_OF_CUSTODY", "SPECIMEN_DOCUMENTATION", "TEMPERATURE_LOG", "PROOF_OF_DELIVERY", "INCIDENT_DOCUMENTATION", "OTHER"],
  POLICIES: ["SIGNED_POLICY", "HANDBOOK_ACKNOWLEDGMENT", "POLICY_ACKNOWLEDGMENT", "CONFIDENTIALITY_ACK", "OTHER"],
  SOPS: ["OTHER"],
};
