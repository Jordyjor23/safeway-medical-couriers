    ...
    <div>
      ...
      <div className="mt-6 overflow-x-auto rounded-2xl border border-line bg-paper">
        <table className="min-w-full text-left text-sm">
          ...
          <tbody>
            {employees.length === 0 ? (
              <tr><td className="px-4 py-8 text-muted" colSpan={5}>No employees yet. Marking an applicant Hired creates an onboarding record.</td></tr>
              ...
              <tr key={employee.id} className="border-b border-line last:border-0">
                ...
                <td className="px-4 py-3">
                  <Link href={`/dashboard/employees/${employee.id}`} className="font-medium text-navy hover:text-medical">
