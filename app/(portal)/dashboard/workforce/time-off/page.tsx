  ...
  return (
    <div className="space-y-8">
      <div>
        ...
        <h1 className="mt-3 text-3xl font-semibold text-navy">PTO, leave & call-offs</h1>
        <p className="mt-2 text-sm text-muted">Employees can submit requests from self-service; managers can review them here.</p>
      </div>
