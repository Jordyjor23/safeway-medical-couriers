              ...
              <div key={route.id} className="rounded-2xl border border-line bg-ice p-4">
                ...
                {canEdit ? (
                  <form action={updateRouteTemplate.bind(null, route.id)} className="mt-4 grid gap-3 sm:grid-cols-2">
                    ...
                    <label className="text-sm font-semibold text-navy">Required route documents<input name="requiredDocumentTypes" defaultValue={route.requiredDocumentTypes ?? ""} placeholder="ROUTE_SPECIFICATION,PICKUP_INSTRUCTIONS" className={fieldClass} /></label>
