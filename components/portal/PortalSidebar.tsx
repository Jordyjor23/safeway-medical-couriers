...
const items: NavItem[] = [
  ...
  { href: "/dashboard/workforce/schedule", label: "Schedule", permission: "workforce.view", icon: CalendarDays },
  { href: "/dashboard/workforce/timecards", label: "Timecards", permission: "workforce.view", icon: Clock3 },
  { href: "/dashboard/workforce/leave", label: "PTO & call-offs", permission: "workforce.view", icon: CalendarDays },
  { href: "/dashboard/payroll", label: "Payroll", permission: "payroll.view", icon: WalletCards },
